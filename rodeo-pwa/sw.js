...
precaching.precacheAndRoute([
  ...
  { url: '/css/estilos.css', revision: '30' },
  { url: '/js/app.js', revision: '30' },
  { url: '/js/rodeo-oficial.js', revision: '30' },
  { url: '/js/vacunas.js', revision: '30' },
  { url: '/js/inseminaciones.js', revision: '30' },
  { url: '/js/db.js', revision: '30' },
  { url: '/js/bluetooth.js', revision: '30' },
  { url: '/js/sync.js', revision: '30' },
  { url: '/js/recorrida.js', revision: '30' },
  { url: '/js/fotos.js', revision: '30' },
  { url: '/js/videos.js', revision: '30' },
  { url: '/js/push.js', revision: '30' },
  { url: '/js/calendario.js', revision: '30' },
  { url: '/manifest.json', revision: '30' },
]);
