...
precaching.precacheAndRoute([
  { url: '/', revision: '71' },
  { url: '/index.html', revision: '71' },
  { url: '/css/estilos.css', revision: '71' },
  { url: '/css/rodeo-chips.css', revision: '71' },
  { url: '/js/app.js', revision: '71' },
  { url: '/js/rodeo-oficial.js', revision: '71' },
  { url: '/js/vacunas.js', revision: '71' },
  { url: '/js/inseminaciones.js', revision: '71' },
  { url: '/js/db.js', revision: '71' },
  { url: '/js/bluetooth.js', revision: '71' },
  { url: '/js/sync.js', revision: '71' },
  { url: '/js/recorrida.js', revision: '71' },
  { url: '/js/fotos.js', revision: '71' },
  { url: '/js/fotos-animal.js', revision: '71' },
  { url: '/js/videos.js', revision: '71' },
  { url: '/js/push.js', revision: '71' },
  { url: '/js/calendario.js', revision: '71' },
  { url: '/js/pesos-modulo.js', revision: '71' },
  { url: '/js/agenda.js', revision: '71' },
  { url: '/manifest.json', revision: '71' },
]);
